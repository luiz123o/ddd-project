"use strict";var s=require("repl"),l=require("./package-d0720f8f.cjs"),u=require("./index-6a8696ce.cjs");require("url"),require("esbuild"),require("crypto"),require("fs"),require("path"),require("os");function c(e){return e&&typeof e=="object"&&"default"in e?e:{default:e}}var f=c(s);console.log(`Welcome to tsx v${l.version} (Node.js ${process.version}).
